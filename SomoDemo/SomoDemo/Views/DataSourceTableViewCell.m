...
- (NSArray<SomoView *> *)somoSkeletonLayout{
	...
	SomoView * s1 = [[SomoView alloc] initWithFrame:CGRectMake(100, 20, 100, 15)];
	SomoView * s2 = [[SomoView alloc] initWithFrame:CGRectMake(100, 45, 200, 15)];
	SomoView * s3 = [[SomoView alloc] initWithFrame:CGRectMake(100, 70, 120, 15)];
	return @[s0,s1,s2,s3];
}
